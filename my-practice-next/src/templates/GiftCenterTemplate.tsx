...
import GiftCenterPage from "@/views/GiftCenterPage";
import Header from "@/components/Header";
import Footer from "@/components/Footer";
import LoginDialog from "@/components/LoginDialog";
import ScrollToTop from "@/components/ScrollToTop";
import "@/styles/gift-center.scss";

function GiftCenterTemplate({ data }: any) {
  ...
  return (
    <>
      <div className="responsive home-1" id="wrapper-container">
        ...
        <GiftCenterPage data={data}></GiftCenterPage>
        <Footer></Footer>
      </div>
      <LoginDialog
...
export default GiftCenterTemplate;
